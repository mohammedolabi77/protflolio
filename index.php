...
<html lang="en">
    ...
    <head>
        ...
        <!-- Bootstrap -->
        <link rel="stylesheet" href="http://mohammedolabi.42web.io/css/bootstrap.min.css">
        <link rel="stylesheet" href="http://mohammedolabi.42web.io/css/all.min.css">
        <link rel="stylesheet" href="http://mohammedolabi.42web.io/css/my_css.css">
        <!-- my css files  -->
...
?>
    <div class="side-nav">
        <div class="position-absolute ">
            <a href="http://mohammedolabi.42web.io/index.php" class="side-link active "><img src="images/home.png"
